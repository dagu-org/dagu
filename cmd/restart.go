...
func stopDAGIfRunning(e engine.Engine, dg *dag.DAG) {
...
func getPreviousExecutionParams(e engine.Engine, dg *dag.DAG) string {
	st, err := e.GetLatestStatus(dg)
	checkError(err)
