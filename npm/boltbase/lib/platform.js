...
const PLATFORM_MAP = {
  ...
  "linux-x64": "boltbase-linux-x64",
  "linux-arm64": "boltbase-linux-arm64",
  "darwin-x64": "boltbase-darwin-x64",
  "darwin-arm64": "boltbase-darwin-arm64",
  "win32-x64": "boltbase-win32-x64",

  // Tier 2 - Common but less frequent
  "linux-ia32": "boltbase-linux-ia32",
  "win32-ia32": "boltbase-win32-ia32",
  "freebsd-x64": "boltbase-freebsd-x64",

  // Tier 3 - Rare platforms
  "win32-arm64": "boltbase-win32-arm64",
  "linux-ppc64": "boltbase-linux-ppc64",
  "linux-s390x": "boltbase-linux-s390x",
  "freebsd-arm64": "boltbase-freebsd-arm64",
  "freebsd-ia32": "boltbase-freebsd-ia32",
  "freebsd-arm": "boltbase-freebsd-arm",
  "openbsd-x64": "boltbase-openbsd-x64",
  "openbsd-arm64": "boltbase-openbsd-arm64",
};
...
function getPlatformPackage() {
  ...
  if (platform === "linux" && arch === "arm") {
    ...
    return `boltbase-linux-armv${variant}`;
  }
...
/**
 * Get the path to the Boltbase binary
