...
const ActionButton = forwardRef<HTMLButtonElement, ActionButtonProps>(
  ({ label, children, icon, className, disabled, onClick, ...props }, ref) => {
    ...
    const baseStyles =
      'inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-1 focus-visible:ring-ring cursor-pointer';
