    ...
    <div className="space-y-3">
      ...
      {status.params && (
        <div className="border-b border-slate-200 pb-3">
          ...
          <div className="p-2 bg-slate-200 rounded-md font-medium text-xs text-slate-800 font-mono max-h-[100px] overflow-y-auto w-full border">
            {status.params}
          </div>
        </div>
      )}
        ...
        {status.dagRunId && (
          <div className="flex items-center gap-1.5">
            ...
            <a
              ...
              className="inline-flex items-center text-slate-600 hover:text-slate-800 transition-colors duration-200 cursor-pointer"
      ...
      <div className="md:hidden border-b border-slate-200 pb-2 space-y-2">
        <div>
          <StatusChip status={status.status} size="md">
            {status.statusLabel}
          </StatusChip>
          ...
          <div className="space-y-1">
            ...
            <div>
              <a
                ...
                className="inline-flex items-center gap-1 px-2 py-1 text-xs rounded-md text-slate-600 hover:text-slate-800 hover:bg-slate-100 transition-colors duration-200 cursor-pointer"
                title="Click to view log (Cmd/Ctrl+Click to open in new tab)"
              >
                <FileText className="h-3.5 w-3.5" />
                <span>View Log</span>
      ...
      <div className="border-b border-slate-200 pb-2">
        <div className="flex flex-col md:flex-row flex-wrap items-start gap-1">
          {status.queuedAt && (
            <div className="flex items-center">
              <Clock className="w-3.5 mr-1 text-slate-500" />
          ...
          <div className="flex items-center">
            <Calendar className="w-3.5 mr-1 text-slate-500" />
          ...
          <div className="flex items-center">
            <Timer className="w-3.5 mr-1 text-slate-500" />
      ...
      <div className="border-b border-slate-200 pb-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {nodeStatus.not_started && (
            <div className="flex items-center">
              <div className="h-2 w-2 mr-1 rounded-full bg-slate-300"></div>
              <span className="text-xs text-slate-600">
        ...
        {isRunning && (
          <div className="mt-1.5 flex items-center text-xs text-slate-600">
          ...
          <div className="space-y-2">
            {status.preconditions
              ...
              .map((cond: components['schemas']['Condition'], idx: number) => (
                <div
                  key={idx}
                  className="p-1.5 bg-amber-50 border border-amber-100 rounded-md text-xs text-amber-600 font-medium"
                >
