...
type StaticRegistry struct {
	coordinators []execution.HostInfo
}
...
func (r *StaticRegistry) Register(_ context.Context, _ execution.ServiceName, _ execution.HostInfo) error {
...
func (r *StaticRegistry) UpdateStatus(_ context.Context, _ execution.ServiceName, _ execution.ServiceStatus) error {
	// Static registry doesn't support status updates
	return nil
}

// Ensure StaticRegistry implements ServiceRegistry
var _ execution.ServiceRegistry = (*StaticRegistry)(nil)
