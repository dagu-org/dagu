...
var (
	...
	ErrExecutorHasInvalidKey               = errors.New("step type config has invalid key")
	ErrExecutorConfigMustBeStringOrMap     = errors.New("step type config must be string or map")
