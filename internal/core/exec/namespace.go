...
var (
	...
	ErrNamespaceHashCollision = errors.New("namespace hash collision: two different names produced the same short ID")
)
...
type Namespace struct {
	...
	// ShortID is a 4-character hex prefix derived from SHA256 of the name.
