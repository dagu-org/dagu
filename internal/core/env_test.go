...
func TestEnv_VariablesMap(t *testing.T) {
	...
	tests := []struct {
		name     string
		setupEnv func(env core.Env) core.Env
...
func TestNewEnv_WorkingDirectory(t *testing.T) {
	...
	tests := []struct {
		...
		step      core.Step
		setupFunc func()
		checkFunc func(t *testing.T, env core.Env)
	}{
		{
...
func TestEnv_EvalString_Precedence(t *testing.T) {
	...
	tests := []struct {
		name     string
		setup    func(ctx context.Context) (context.Context, core.Env)
		input    string
		expected string
	}{
		{
			...
			setup: func(ctx context.Context) (context.Context, core.Env) {
				...
				// Create executor env
				env := core.NewEnv(ctx, core.Step{Name: "test"})
