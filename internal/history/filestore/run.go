...
func (e Run) CreateRecord(_ context.Context, ts TimeInUTC, cache *fileutil.Cache[*models.Status], opts ...RecordOption) (*Record, error) {
...
func (e Run) LatestRecord(_ context.Context, cache *fileutil.Cache[*models.Status]) (*Record, error) {
