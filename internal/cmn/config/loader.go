...
func (l *ConfigLoader) loadUIConfig(cfg *Config, def Definition) {
	...
	cfg.UI.Autopilot.Enabled = l.v.GetBool("ui.autopilot.enabled")
	...
	if def.UI.Autopilot != nil && def.UI.Autopilot.Enabled != nil {
		cfg.UI.Autopilot.Enabled = *def.UI.Autopilot.Enabled
	}
}
...
func (l *ConfigLoader) setViperDefaultValues(paths Paths) {
	...
	l.v.SetDefault("ui.autopilot.enabled", false)
...
var envBindings = []envBinding{
	...
	{key: "ui.autopilot.enabled", env: "UI_AUTOPILOT_ENABLED"},
	// UI (legacy)
