...
var legacyToSnakeCaseKey = map[string]string{
	...
	"dagrunstore.postgres.server.automigrate":               "dag_run_store.postgres.server.auto_migrate",
	"dagrunstore.postgres.server.pool.maxopenconns":         "dag_run_store.postgres.server.pool.max_open_conns",
	"dagrunstore.postgres.server.pool.maxidleconns":         "dag_run_store.postgres.server.pool.max_idle_conns",
	"dagrunstore.postgres.server.pool.connmaxlifetime":      "dag_run_store.postgres.server.pool.conn_max_lifetime",
	"dagrunstore.postgres.server.pool.connmaxidletime":      "dag_run_store.postgres.server.pool.conn_max_idle_time",
	"dagrunstore.postgres.scheduler.automigrate":            "dag_run_store.postgres.scheduler.auto_migrate",
	"dagrunstore.postgres.scheduler.pool.maxopenconns":      "dag_run_store.postgres.scheduler.pool.max_open_conns",
	"dagrunstore.postgres.scheduler.pool.maxidleconns":      "dag_run_store.postgres.scheduler.pool.max_idle_conns",
	"dagrunstore.postgres.scheduler.pool.connmaxlifetime":   "dag_run_store.postgres.scheduler.pool.conn_max_lifetime",
	"dagrunstore.postgres.scheduler.pool.connmaxidletime":   "dag_run_store.postgres.scheduler.pool.conn_max_idle_time",
	"dagrunstore.postgres.agent.automigrate":                "dag_run_store.postgres.agent.auto_migrate",
	"dagrunstore.postgres.agent.directaccess":               "dag_run_store.postgres.agent.direct_access",
	"dagrunstore.postgres.agent.pool.maxopenconns":          "dag_run_store.postgres.agent.pool.max_open_conns",
	"dagrunstore.postgres.agent.pool.maxidleconns":          "dag_run_store.postgres.agent.pool.max_idle_conns",
	"dagrunstore.postgres.agent.pool.connmaxlifetime":       "dag_run_store.postgres.agent.pool.conn_max_lifetime",
	"dagrunstore.postgres.agent.pool.connmaxidletime":       "dag_run_store.postgres.agent.pool.conn_max_idle_time",
	"dag_run_store.postgres.server.automigrate":             "dag_run_store.postgres.server.auto_migrate",
	"dag_run_store.postgres.server.pool.maxopenconns":       "dag_run_store.postgres.server.pool.max_open_conns",
	"dag_run_store.postgres.server.pool.maxidleconns":       "dag_run_store.postgres.server.pool.max_idle_conns",
	"dag_run_store.postgres.server.pool.connmaxlifetime":    "dag_run_store.postgres.server.pool.conn_max_lifetime",
	"dag_run_store.postgres.server.pool.connmaxidletime":    "dag_run_store.postgres.server.pool.conn_max_idle_time",
	"dag_run_store.postgres.scheduler.automigrate":          "dag_run_store.postgres.scheduler.auto_migrate",
	"dag_run_store.postgres.scheduler.pool.maxopenconns":    "dag_run_store.postgres.scheduler.pool.max_open_conns",
	"dag_run_store.postgres.scheduler.pool.maxidleconns":    "dag_run_store.postgres.scheduler.pool.max_idle_conns",
	"dag_run_store.postgres.scheduler.pool.connmaxlifetime": "dag_run_store.postgres.scheduler.pool.conn_max_lifetime",
	"dag_run_store.postgres.scheduler.pool.connmaxidletime": "dag_run_store.postgres.scheduler.pool.conn_max_idle_time",
	"dag_run_store.postgres.agent.automigrate":              "dag_run_store.postgres.agent.auto_migrate",
	"dag_run_store.postgres.agent.directaccess":             "dag_run_store.postgres.agent.direct_access",
	"dag_run_store.postgres.agent.pool.maxopenconns":        "dag_run_store.postgres.agent.pool.max_open_conns",
	"dag_run_store.postgres.agent.pool.maxidleconns":        "dag_run_store.postgres.agent.pool.max_idle_conns",
	"dag_run_store.postgres.agent.pool.connmaxlifetime":     "dag_run_store.postgres.agent.pool.conn_max_lifetime",
	"dag_run_store.postgres.agent.pool.connmaxidletime":     "dag_run_store.postgres.agent.pool.conn_max_idle_time",
