...
func (rp *Reporter) ReportStep(cfg *dag.DAG, status *models.Status, node *scheduler.Node) error {
	st := node.ReadStatus()
...
func (rp *Reporter) SendMail(cfg *dag.DAG, status *models.Status, err error) error {
