...
func (e Execution) CreateRecord(_ context.Context, ts TimeInUTC, cache *fileutil.Cache[*models.Status], opts ...RecordOption) (*Record, error) {
...
func (e Execution) LatestRecord(_ context.Context, cache *fileutil.Cache[*models.Status]) (*Record, error) {
...
func formatExecTimestamp(t TimeInUTC) string {
