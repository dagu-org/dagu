...
type Definition struct {
	...
	Kind                AutopilotKind `json:"kind" yaml:"kind,omitempty"`
...
func (d *Definition) UnmarshalYAML(value *yaml.Node) error {
	type rawDefinition struct {
		Kind                     AutopilotKind `yaml:"kind,omitempty"`
	...
	d.Kind = normalizeAutopilotKind(raw.Kind)
...
func (d *Definition) normalizeGoal() {
	...
	d.Kind = normalizeAutopilotKind(d.Kind)
...
func normalizeAutopilotKind(_ AutopilotKind) AutopilotKind {
	return AutopilotKindWorkflow
}
