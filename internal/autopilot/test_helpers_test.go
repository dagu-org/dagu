...
type testAutopilotEventStore struct {
	events []*eventstore.Event
}

func (s *testAutopilotEventStore) Emit(_ context.Context, event *eventstore.Event) error {
	if event == nil {
		return nil
	}
...
func (*testAutopilotEventStore) Query(context.Context, eventstore.QueryFilter) (*eventstore.QueryResult, error) {
...
func newTestServiceWithEventStore(t *testing.T) (*Service, time.Time, *testAutopilotEventStore) {
	t.Helper()
...
func autopilotSpec(allowedDAG string) string {
	return `description: Software development autopilot
...
func autopilotSpecWithModel(allowedDAG, model string) string {
	return `description: Software development autopilot
goal: Complete the assigned software work
allowed_dags:
  names:
...
func autopilotSpecMultiDAGs() string {
	return `description: Software development autopilot
goal: Complete the assigned software work
allowed_dags:
  names:
...
func autopilotSpecWithSchedule(allowedDAG, schedule string) string {
	return `description: Software development autopilot
goal: Complete the assigned software work
schedule: "` + schedule + `"
allowed_dags:
...
func serviceAutopilotSpec(allowedDAG string) string {
	return `kind: service
...
func serviceAutopilotSpecWithSchedule(allowedDAG, schedule string) string {
	return `kind: service
description: Software development autopilot
goal: Complete the assigned software work
standing_instruction: Handle inbound work continuously.
