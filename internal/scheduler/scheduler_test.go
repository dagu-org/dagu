...
func TestScheduler(t *testing.T) {
	...
	t.Run("Start", func(t *testing.T) {
		...
		sc, err := scheduler.New(th.Config, entryReader, th.DAGRunMgr, th.DAGRunStore, th.QueueStore, th.ProcStore, th.ServiceMonitor, th.Dispatcher)
	...
	t.Run("NextTick", func(t *testing.T) {
		...
		th := test.SetupScheduler(t)
		schedulerInstance, err := scheduler.New(th.Config, &mockJobManager{}, th.DAGRunMgr, th.DAGRunStore, th.QueueStore, th.ProcStore, th.ServiceMonitor, th.Dispatcher)
		require.NoError(t, err)
...
func TestFileLockPreventsMultipleInstances(t *testing.T) {
	...
	sc1, err := scheduler.New(th.Config, entryReader, th.DAGRunMgr, th.DAGRunStore, th.QueueStore, th.ProcStore, th.ServiceMonitor, th.Dispatcher)
	require.NoError(t, err)
	...
	sc2, err := scheduler.New(th.Config, entryReader, th.DAGRunMgr, th.DAGRunStore, th.QueueStore, th.ProcStore, th.ServiceMonitor, th.Dispatcher)
	require.NoError(t, err)
