...
`)
	...
	require.Equal(t, "from-host|", runtimeStatusOutputValue(t, &status, "RESULT"))
}

func runtimeStatusOutputValue(t *testing.T, status *exec.DAGRunStatus, key string) string {
	t.Helper()
