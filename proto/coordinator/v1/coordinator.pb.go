...
type Task struct {
	...
	// How this run was triggered (scheduler, catchup, manual, etc.)
	TriggerType string `protobuf:"bytes,18,opt,name=trigger_type,json=triggerType,proto3" json:"trigger_type,omitempty"`
	// When the run was scheduled for (RFC3339 format)
	ScheduledTime string `protobuf:"bytes,19,opt,name=scheduled_time,json=scheduledTime,proto3" json:"scheduled_time,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Task) GetScheduledTime() string {
	if x != nil {
...
const file_proto_coordinator_v1_coordinator_proto_rawDesc = "" +
	...
	"baseConfig\x12!\n" +
	"\ftrigger_type\x18\x12 \x01(\tR\vtriggerType\x12%\n" +
	"\x0escheduled_time\x18\x13 \x01(\tR\rscheduledTime\x1aA\n" +
